...
namespace ConcertBooking.Application.Services.Implementations
{
    public class BookingService : IBookingService
    {
        ...
        {
            var bookings= _unitOfWork.BookingRepository.GetAll(filter:x=>x.ConcertId ==concertId,include:b=>b.Include(a=>a.Ticket).Include(c=>c.Concert).Include(u=>u.ApplicationUser));
            return bookings;
        }
    }
}
